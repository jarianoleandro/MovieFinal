...
<form id="formInserirUsuario" name="formInserirUsuario" method="post" action="insereUsuarioNovo.php">
  <p>
...
<br> -->
<a href="index.php">  
  <button class="btn btn-secondary" type="button">Retornar para o Login</button>
</a>
